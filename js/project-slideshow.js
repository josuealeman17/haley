...
let projectTitle = document.getElementsByClassName("project__title");
let projectImage = document.getElementsByClassName(".project__img");
let blContainer = document.getElementById("#grid__bl__content");
let slideIndex = 1;
...
function showProject(num) {
  ...
  project[slideIndex - 1].style.heigth = "100%"; 
}
