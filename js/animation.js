...
const trContentTwo = document.querySelector(".cards");
const blContent = document.querySelector("#grid__bl__content");
const blContentTwo = document.querySelector("#grid__bl__content__projects");
const brContent = document.querySelector("#grid__br__content");
const brContentTwo = document.querySelector(".incoming__call");
  ...
  switch (activeCorner) {
    ...
    case "bottom-left":
      if (window.innerWidth <= 600) {
        ...
        blContentTwo.style.minWidth = "300.5px";
        blContentTwo.style.height = "auto";
        ...
        blContent.style.alignItems = "center";
        blContent.style.justifyContent = "center";
        blContentTwo.style.minWidth = "50%";
        blContentTwo.style.maxWidth = "50%";
        blContent.style.background = "var(--bg-transparent)";
        blContent.style.zIndex = "200";
        trBtn.style.zIndex = "100";
        tlBtn.style.zIndex = "100";
        ...
        blContent.style.width = "16rem";
        blContent.style.height = "250px";
        blContentTwo.style.minWidth = "90%";
        blContentTwo.style.maxWidth = "100%";
        blContent.style.top = "-5vh";
        blContent.style.display = "flex";
        blContent.style.position = "relative";
        blContent.style.background = "var(--bg)";
        blContentTwo.style.width = "100%";
      }
      break;
    ...
    case "bottom-right":
      if (window.innerWidth <= 1100) {
        ...
        brContentTwo.style.width = "30%";
        brContentTwo.style.maxWidth = "208px";
        brContentTwo.style.minWidth = "208px";
        brContentTwo.style.height = "400px";
...
function playClosingAnimation(reverseAnimation) {
  ...
  trBtn.innerHTML = "Strengths";
  blBtn.innerHTML = "Memories";
  brBtn.innerHTML = "????";
...
trBtn.onclick = function () {
  if (activeCorner === "top-right") {
    ...
    trBtn.innerHTML = "&uarr;<br/>Strengths";
...
blBtn.onclick = function () {
  if (activeCorner === "bottom-left") {
    ...
    blBtn.innerHTML = "Memories<br/>&darr;";
